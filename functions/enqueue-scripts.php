...
function site_scripts()
{
	...
	wp_enqueue_script(
		'main',
		get_template_directory_uri() . '/public/scripts.js',
		array('jquery'),
		filemtime(get_template_directory() . '/public/scripts.js'),
		true
	);
	...
	wp_enqueue_script(
		'layout-blocks',
		get_template_directory_uri() . '/public/layout-blocks.js',
		array('jquery'),
		filemtime(get_template_directory() . '/public/layout-blocks.js'),
		true
	);
...
function both_frontend_and_editor_assets()
{
	...
	wp_enqueue_style(
		'vendor-styles',
		get_template_directory_uri() . '/public/vendor-styles.css',
		array(),
		filemtime(get_template_directory() . '/public/vendor-styles.css'),
		'all'
	);
	...
	wp_enqueue_style(
		...
		array(),
		filemtime(get_template_directory() . '/public/styles.css'),
		'all'
	);
