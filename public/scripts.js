...
(() => {
/*!***********************************************!*\
  !*** ./assets/scripts/js/components/_init.js ***!
  \***********************************************/
/**
Global Variables that all snippets will use or have access to
 */
...
(() => {
/*!****************************************************!*\
  !*** ./assets/scripts/js/components/animations.js ***!
  \****************************************************/
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var gsap = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
var Animations = function Animations(el) {
  this.init();
};
...
(() => {
/*!*********************************************************!*\
  !*** ./assets/scripts/js/components/audio-shortcode.js ***!
  \*********************************************************/
/**
 *
 * Audio Shortcode
...
(() => {
/*!*********************************************************!*\
  !*** ./assets/scripts/js/components/init-foundation.js ***!
  \*********************************************************/
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var foundation = __webpack_require__(/*! foundation-sites */ "./node_modules/foundation-sites/dist/js/foundation.esm.js");
...
(() => {
/*!**********************************************!*\
  !*** ./assets/scripts/js/components/menu.js ***!
  \**********************************************/
/**
 *
 * Menu
...
(() => {
/*!***************************************************!*\
  !*** ./assets/scripts/js/components/quick-nav.js ***!
  \***************************************************/
/**
 *
 * Quick Nav
...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var QuickNav = function QuickNav(el) {
  this.$el = $(el);
  ...
  this.QuickList = new Foundation.Dropdown(this.$dropDownList, {
    parentClass: 'kw-c-quick-nav__wrapper',
    alignment: 'bottom',
    position: 'left',
    closeOnClick: true
  });
  ...
  var observer = new IntersectionObserver(function (entries) {
    ...
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        var $activeEl = _this.$quickNavAnchor.find("[data-target=".concat($entryId, "]"));

        //console.log( $entryId, $activeEl );

        _this.$quickNavItems.removeClass('kw-is-active');
        $activeEl.addClass('kw-is-active');
      }
    });
  }, config);
  this.$blocks.get().forEach(function (image) {
...
(() => {
/*!**************************************************!*\
  !*** ./assets/scripts/js/components/sections.js ***!
  \**************************************************/
/**
 *
 * Menu Sections
 ...
 */
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var Sections = function Sections(el) {
...
Sections.prototype.event__handleShowSection = function (event) {
  ...
  this.targetSection = this.$sections.filter(function (key, el) {
    return parseInt($(el).attr("data-menu")) === parseInt(_this.targetId);
  });
...
(() => {
/*!*************************************************!*\
  !*** ./assets/scripts/js/components/sidebar.js ***!
  \*************************************************/
/**
 *
 * Sidebar
...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var SidebarUI = function SidebarUI(el) {
  this.$el = $(el);
...
SidebarUI.prototype.validateContent = function () {
  var _this = this;
  this.$triggers.each(function (index, el) {
    var $el = $(el);
    var href = $el.attr('href');
    var entry = _this.$el.find(href);
    if (!entry.length) {
      $el.removeClass('has-content').replaceWith(function () {
        return $('<span/>', {
          html: $(this).text()
        });
      });
...
(() => {
/*!*******************************************************!*\
  !*** ./assets/scripts/js/components/wp-foundation.js ***!
  \*******************************************************/
/*
