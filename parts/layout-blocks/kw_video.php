...
namespace ITBL\LayoutBlock\kw_video;
/**
...
function register_block() {
	...
	if( function_exists('acf_register_block_type') ) {
		$block_registered = acf_register_block_type( array(
				...
				'description'       => __('Plays a video from any source'),
				'render_callback'   => __NAMESPACE__ . '\\' .'kw_video',
				'category'          => 'kw-blocks',
				'icon'              => 'format-video',
				'align'             => 'full',
				'mode'              => 'auto',
...
function kw_video( $block, $content, $is_preview, $post_id  ){
	...
	<section id="<?php echo $slug; ?>" class="kw-c-block kw-c-video">
		...
		<div class="grid-container">
			...
			<div class="grid-x grid-margin-x grid-margin-y kw-c-col__wrapper">
				...
				<div class="cell small-12 medium-8 large-9 kw-c-col__main">
					
					<div class="responsive-embed widescreen">
						<iframe width="560" height="315" src="<?php echo $video; ?>" style="border-radius: 4px;" allowfullscreen></iframe>
					</div>
