	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<section id="page-hero" class="front-page-hero">
							...
							<article class="kw-front-page-carousel__slide <?php echo $slide_type; ?>">
								...
								//we have a video, so run this UI responsive-embed widescreen
									...
									<div class="kw-front-page__carousel-video">
										<!--									<iframe src="--><?php //echo $slide_video; 
																								?>
										<!--" style="border-radius: 4px;" allowfullscreen></iframe>-->
			...
			<?php if (has_blocks($post->ID)) : ?>
				<a href="#front-page-main" data-smooth-scroll data-options="offset:0" class="kw-front-page__continue">Continue <span class="kw-u-ml-3 fas fa-long-arrow-alt-down animated bounce-in" aria-hidden="true"></span></a>
			<?php endif; ?>
